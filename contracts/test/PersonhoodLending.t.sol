...
contract PersonhoodLendingTest is Test {
    ...
    function testCreateAgreement() public {
        ...
        vm.prank(lender);
        uint256 agreementId = personhoodLending.createAgreement{value: collateral}(
            borrower,
            context,
            duration
        );
    ...
    function test_RevertWhen_ZeroAddressBorrower() public {
        ...
        personhoodLending.createAgreement{value: 1 ether}(
            address(0),
            "Test Context",
            1 days
        );
    ...
    function test_RevertWhen_ZeroCollateral() public {
        ...
        personhoodLending.createAgreement(
            borrower,
            "Test Context",
            1 days
        );
